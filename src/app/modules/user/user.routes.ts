...
router.get('/admin/referral-tree', auth(userRole.admin), userController.getReferralTree);
router.get('/admin/referrals/:id', auth(userRole.admin), userController.getUserReferrals);
